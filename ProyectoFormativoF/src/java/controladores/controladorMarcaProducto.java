 ...
 * @author ADMON
 */
@WebServlet(name = "controladorMarcaProducto", urlPatterns = {"/controladorMarcaProducto"})
public class controladorMarcaProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet controladorMarcaProducto</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet controladorMarcaProducto at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombreMarca = request.getParameter("fNombreMarca");
        String accion = request.getParameter("fOpcion");
        
        //Castim 

        MarcaProducto unaMarca = null;
        ...
        try {
            ...
            unaMarca.setIdMarcaProducto(idMarcaProducto);
